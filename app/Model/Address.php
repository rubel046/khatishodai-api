...
class Address extends Model
{
    ...
    protected $fillable = ['addressable_id','address','address_type', 'area_id', 'city_id', 'division_id', 'district_id','country_id', 'created_by', 'updated_by', 'deleted_at', 'created_at', 'updated_at', 'ip_address'];

...
$router->group(['prefix' => 'btype'], function () use ($router) {
...
$router->group(['prefix' => 'product/attribute/group'], function () use ($router) {
...
$router->group(['prefix' => 'product/attribute'], function () use ($router) {
...
$router->group(['prefix' => 'menu_operations'], function () use ($router) {
...
$router->group(['prefix' => 'comp_certificates'], function () use ($router) {
...
$router->group(['prefix' => 'comp_details'], function () use ($router) {
...
$router->group(['prefix' => 'comp_factories'], function () use ($router) {
...
// API route company Factory
$router->group(['prefix' => 'comp_nearest_ports'], function () use ($router) {
...
$router->group(['prefix' => 'comp_photos'], function () use ($router) {
...
$router->group(['prefix' => 'comp_products'], function () use ($router) {
...
$router->group(['prefix' => 'comp_trade_infos'], function () use ($router) {
...
$router->group(['prefix' => 'comp_trade_memberships'], function () use ($router) {
